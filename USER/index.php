  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="images/PNG/logo.png" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="images/PNG/logo-mini.png" alt="logo"/></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/pedidos/pedidos.php ">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Bienvenido a RIZER</h3>
                  <h6 class="font-weight-normal mb-0">Saciando tu hambre al alcance de un Click. <span class="text-primary">3 alertas sin revisar</span></h6>
                </div>
                <div class="col-12 col-xl-4">
                 <div class="justify-content-end d-flex">
                  <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                    <button class="btn btn-sm btn-light bg-white dropdown-toggle" type="button" id="dropdownMenuDate2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                     <i class="mdi mdi-calendar"></i> Hoy (01 Oct 2021)
                    </button>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                      <a class="dropdown-item" href="#">Enero - Marzo</a>
                      <a class="dropdown-item" href="#">Abril - Junio</a>
                      <a class="dropdown-item" href="#">Julio - Septiembre</a>
                      <a class="dropdown-item" href="#">Octubre - Diciembre</a>
                    </div>
                  </div>
                 </div>
                </div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="images/Variant01.jpg" alt="people">
                  <div class="weather-info">
                    <div class="d-flex">
                      <div>
                        <h2 class="mb-0 font-weight-normal text-white"><i class="icon-sun mr-2 text-white"></i>19<sup>C°</sup></h2>
                      </div>
                      <div class="ml-2">
                        <h4 class="location font-weight-normal text-white">Abejorral</h4>
                        <h6 class="font-weight-normal text-white">Antioquia</h6>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      <p class="mb-4">User</p>
                      <p class="fs-30 mb-2">ASC</p>
                      <p>Area superficie corporal</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent">
              ...
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      <p class="mb-4">User</p>
                      <p class="fs-30 mb-2">MCM</p>
                      <p>Masa corporal Magra</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      <p class="mb-4">User</p>
                      <p class="fs-30 mb-2">Consejos</p>
                      <p>Creamos una lista adecuada para ti</p>
                    </div>
                  </div>
                </div>
              </div>
