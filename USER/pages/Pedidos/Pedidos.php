        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Realiza tu pedido</h4>
                  <form class="form-sample">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nombre del pedido</label>
                          <div class="col-sm-9">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Número de porciones</label>
                          <div class="col-sm-9">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Receta </label>
                          <div class="col-sm-9">
                            <select class="form-control">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Recordar configurción</label>
                          <div class="col-sm-4">
                            <div class="form-check">
                              <label class="form-check-label">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nivel de agua</label>
                          <div class="col-sm-9">
                          <select class="form-control">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nivel de aceite</label>
                          <div class="col-sm-9">
                          <select class="form-control">
                              <option>Predeterminada</option>
                              <option>opción 1</option>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nivel de sal</label>
                          <div class="col-sm-9">
                          <select class="form-control">
                              <option>Predeterminada</option>
                              <option>opción 1</option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nivel de arroz</label>
                          <div class="col-sm-9">
                          <select class="form-control">
                              <option>Predeterminada</option>
                              <option>opción 1</option>
                          ...
                          <a href="Profile.php " class="btn btn-light mb-2">Cancelar</a>
                        </div>
                      </div>
                    </div>
                      </div>
