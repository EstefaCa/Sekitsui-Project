<?php
  ...
  if(isset($_SESSION['Users_Id'])){
    ...
    if ($Sentencia->rowCount()>=1) {
        ...
        $Roles_Roles_Id = $fila['Roles_Roles_Id'];
        $Users_Name = $fila['Users_Name'];
        $Users_LastName = $fila['Users_LastName'];
        $Users_User = $fila['Users_User'];
        $Users_Email = $fila['Users_Email'];
        $Users_Telephone = $fila['Users_Telephone'];
    }
    ...
    if ($Sentencia2->rowCount()>=1) {
      $fila = $Sentencia2->fetch();
      $Details_Weight = $fila['Details_Weight'];
      $Details_Size = $fila['Details_Size'];
      $Details_Date_of_birth = $fila['Details_Date_of_birth'];
      $Details_Gender = $fila['Details_Gender'];
      $Details_Physical_activity = $fila['Details_Physical_activity'];
  }
}   
?>
<!DOCTYPE html>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                            <h5>
                                <?php echo $Users_Name," ". $Users_LastName;?>
                            </h5>
                            <h6>
                                <?php if ($Roles_Roles_Id == 1) {
                                  echo "Usuario";
                                } else {
                                  echo "Administrador";
                                }?>
            ...
            <div class="col-md-2">
                <a class="btn btn-outline-primary rounded" href="edit_profile.php">Editar</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="tab-content profile-tab" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><?php echo $Users_Name, " ", $Users_LastName; ?></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><?php echo $Details_Weight, " kg";?> </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><?php echo $Details_Date_of_birth;?></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <p><?php echo $Details_Gender;?></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Horas de ejercicio semanal</label>
                                    </div>
                                    <div class="col-md-6">
                                        <p><?php echo $Details_Physical_activity;?></p>
                                    </div>
                                </div>
                    </div>
                </div>
